...
//		}
		...
		char arr5[]  = "ACTS".toCharArray();
		String str = new String(arr5);
		
		String[] names = new String[10];
		Arrays.fill(names, "Alia");
		System.out.println(Arrays.toString(names));
		
		String str2 = "How are you doing today? Did you take breakfast coupens?";
		String[] spaceArray = str2.split(" ");
		System.out.println(Arrays.toString(spaceArray));
		String[] questionArray = str2.split("\\?");
